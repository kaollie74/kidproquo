...
router.get('/:id', rejectUnauthenticated,  (req, res) => {
    ...
    const sqlText = `select "event"."offer_needed", "event"."claimer_id", "event"."requester_id", "family"."image" as "claimer_image", "family2"."image" as "requester_image", "family2"."last_name1" as "requester_name", "family"."last_name1" as "claimer_name", "event"."id", "event"."event_date", "event"."event_time_start", "event"."event_time_end", "event"."event_claimed"from "event"
                    left join "family" on
...
router.get('/notifications/:id', rejectUnauthenticated,  (req, res) => {
    ...
    const id = req.params.id;
    const sqlText =`select "family2"."user_id" as "requester_id", "event"."claimer_id", "family"."image" as "claimer_image", 
